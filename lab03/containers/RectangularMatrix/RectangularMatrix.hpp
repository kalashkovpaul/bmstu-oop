...
template <std::size_t rows, std::size_t cols, typename T>
constexpr auto RectangularMatrix<rows, cols, T>::begin() const -> constIterator {
  return data_.begin();
}
...
template <std::size_t rows, std::size_t cols, typename T>
constexpr auto RectangularMatrix<rows, cols, T>::end() const -> constIterator {
  return data_.end();
}

template <std::size_t rows, std::size_t cols, typename T>
constexpr auto RectangularMatrix<rows, cols, T>::operator[](RectangularMatrix::sizeType index) -> reference {
  return data_[index];
}

template <std::size_t rows, std::size_t cols, typename T>
constexpr auto RectangularMatrix<rows, cols, T>::operator[](RectangularMatrix::sizeType index) const -> constReference {
  return data_[index];
}

template <std::size_t rows, std::size_t cols, typename T>
auto RectangularMatrix<rows, cols, T>::at(RectangularMatrix::sizeType index) -> reference {
  if (index >= rows)
...
template <std::size_t rows, std::size_t cols, typename T>
auto RectangularMatrix<rows, cols, T>::at(RectangularMatrix::sizeType index) const -> constReference {
  if (index >= rows)
    throw std::out_of_range("RectangularMatrix::at");
  return data_.at(index);
}
